...
if (!class_exists('TPC_Autoloader_LoaderClass')) {
	class TPC_Autoloader_LoaderClass {
		/**
		 * Base path
		 * @var string
		 */
		 ...
		 */
		public function __construct( $namespaces = 'TPC', $basePath = null ) {
			if( $basePath ) {
		...
		public function register( $prepend = false ) {
			spl_autoload_register( array( $this, 'loadClass' ), $throwException = false, $prepend );
